...
def get_embedding(text: str):
    ...
    try:
        ...
        # Returns the raw vector array from the Vertex API
...
def check_near_duplicate(break_record, threshold=0.92):
    ...
    Saves LLM reasoning costs for clear textual near-duplicates.
    """
    l_desc = break_record.get("ledger", {}).get("description", "")
    p_desc = break_record.get("processor", {}).get("description", "")
    
    # If either description is missing, we can't compare vectors
